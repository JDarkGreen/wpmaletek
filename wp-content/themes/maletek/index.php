...
?>
    ...
    <!-- container-slider -->
    <div id="carousel-mlt" class="carousel slide carousel-fade" data-ride="carousel" data-interval="6000" >
        <div class="carousel-inner">
            <?php require_once('slider-home.php'); ?>
        </div> <!-- /carousel-inner -->

        <!-- Controls -->
        <a class="prev hidden-xs" href="#carousel-mlt" role="button" data-slide="prev"></a>
        <a class="next hidden-xs" href="#carousel-mlt" role="button" data-slide="next"></a>
    </div> <!-- /carousel -->

    <!-- Button ver productos -->
    <a href="<?php echo home_url('shop'); ?>" class="btn-products--red visible-xs-block text-uppercase text-center">ver nuestros productos</a>
    <!-- clearfix -->
    <div class="clearfix"></div>

    <!-- container botoner -->
    <div class="wrapper-botoner hidden-xs">
        <?php get_sidebar('main-sidebar'); ?>
    </div> <!-- end of wrapper-botoner -->

    <!-- Button trigger modal -->
    <button id="btnLightbox" class="hidden-xs" data-toggle="modal" data-target="#myModal"></button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 id="myModalLabel">Formulario de Contacto</h3>
                </div>
                <div class="modal-body">
                    <?php $sr_only = (is_ie() && get_browser_version() <= 9) ? '' : 'sr-only'; ?>
                    <!-- Change the "action" attribute to your back-end URL -->
                    <form id="registrationForm" method="post" action="<?php echo home_url(); ?>">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="form-group <?php if ($error_asunto) echo 'has-error'; ?>">
                                    ...
                                    <select class="form-control" name="contact_asunto" id="contact_asunto">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="form-group <?php if ($error_message) echo 'has-error'; ?>">
                                    ...
                                    <textarea class="form-control" id="contact_message" name="contact_message" placeholder="Describe el uso que deseas dar al locker..." rows="4"><?php if (isset($_POST['contact_message'])) echo stripslashes($_POST['contact_message']); ?>
                                    </textarea>
                                </div>
