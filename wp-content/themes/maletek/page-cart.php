		...
		<div class="container">
			<div class="row">
				...
				<?php if (have_posts()) : while(have_posts()) : the_post(); ?>
					...
					<article class="page-content page-content-cart">
						
						<!-- mostrar la seccion carrito mediante un link -->
						<a class="proccess-buy text-uppercase" href="#"><span>1</span><?php _e('Cotizador', THEMEDOMAIN);  ?></a>
				...
				<?php  
					...
					$args = apply_filters( 'woocommerce_related_products_args', array(
						'post_type'            => 'product', // ti po de post
						'ignore_sticky_posts'  => 1,  // ignorar el principal
						'no_found_rows'        => 1,
						'posts_per_page'       => 4  // cuantos post por pagina se mostraran
					) );
