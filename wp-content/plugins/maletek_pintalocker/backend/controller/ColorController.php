    ...
    function table(){
        ...
        if($regs){
            foreach ($regs as $r) {
                ...
                $aaData[]=array(
                    $r['id'],
                    '<a itemid="'.$r['id'].'" itemref="Color" href="'.MALETEKPL__BACKEND_CONTROLLER.'?controller=color&action=edit" class="editReg">'.$r['varName'].'</a>',
                    '<a href="'.MALETEKPL__PLUGIN_URL.'resources/color/'.$r['varImage'].'" class="fancybox">Ver</a>',
