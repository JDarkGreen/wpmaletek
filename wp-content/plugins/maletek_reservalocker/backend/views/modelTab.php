...
?>
<a class="button addReg" itemref="<?php echo $controller ?>" href="#">Agregar Modelo</a>
...
<div class="hidden">
    ...
    <form action="<?php echo MALETEKPL_RSV_BACKEND_CONTROLLER ?>" method="post" class="adminForm" id="adminForm<?php echo $controller ?>" itemid="table<?php echo $controller ?>" enctype="multipart/form-data">
        ...
        <div class="field">
            <label># Filas</label>
            <div class="input">
                <input name="intRow" id="intRow" class="input-text required numeric loadInput" type="text" title="Contenido inválido" />
            </div>
        </div>
        <div class="field">
            <label># Columnas</label>
            <div class="input">
                <input name="intCol" id="intCol" class="input-text required numeric loadInput" type="text" title="Contenido inválido" />
            </div>
        </div>
        <div class="field">
            <label>&nbsp;</label>
